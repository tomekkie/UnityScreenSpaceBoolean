Shader "Universal Render Pipeline/ScreenSpaceBoolean/Mask"
{
    ...
    SubShader
    {
        ...
        float depth(output i) : SV_Target
        {
            ...
            float subtracteeBack01Depth = Linear01Depth(subtracteeBackDepth, _ZBufferParams);
            float subtractorBackDepth = ComputeDepth(i.spos);
            float subtractorBack01Depth = i.spos.z;

            if (subtractorBack01Depth >= subtracteeBack01Depth) discard;
            return 0;
